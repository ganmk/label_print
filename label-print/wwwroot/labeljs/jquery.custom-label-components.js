...
// 按钮
CustomLabel.addPropsPanelField("button", function (data, Remove) {
    var elem = $('<div><div class="cl-props-label">' + data.label + '</div><div class="cl-props-item"><button>' + data.value + '</button></div></div>');
