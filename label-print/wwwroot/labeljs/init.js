...
$(function () {
    ...
    $(".btn-add-new").on('click',function (e) {
        ...
        customLabel.onSave = function (data) {
            ...
            //console.log(btoa(encodeURI(JSON.stringify(data))));
            console.log(Base64.utf8ToBase64(JSON.stringify(data)));
            $.post('/Label/PutLabel', { label: Base64.utf8ToBase64(JSON.stringify(data)) });
